...
- Sketch the smallest idiomatic DSL that satisfies the issue. Prefer a lambda-with-receiver builder under a `@DslMarker`
  scope. See skill `idiomatic-kotlin-dsl`.
