...
CI architecture: [`docs/CI.md`](docs/CI.md). **Do not add explanatory header comments** in
`.github/workflows/*` or other YAML CI files — job/step names should be enough. No internal audit IDs
(`CI-W1`, …) in repo files or public docs.
