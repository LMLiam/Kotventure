...
internal class SelectorAdvancementsBuilder : SelectorAdvancementsScope {
    ...
    override infix fun Key.eq(completed: Boolean) = put(this, AdvancementCondition.Completed(completed))
    ...
    private fun put(
        ...
        check(advancement !in advancements) {
            "Selector advancement '${advancement.asString()}' is already set; vanilla syntax evaluates one condition per advancement."
        }
