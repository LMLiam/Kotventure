...
public class NbtPredicateKey internal constructor(
    ...
    internal val scope: NbtPredicateBuilder,
)
...
internal class NbtPredicateBuilder : NbtPredicateScope {
    ...
    override fun key(name: String): NbtPredicateKey = NbtPredicateKey(name, this)

    override infix fun NbtPredicateKey.eq(value: String) {
        scope.addEntry(name, NbtLiteralValue.StringValue(value))
    }

    override infix fun NbtPredicateKey.eq(value: Int) {
        scope.addEntry(name, NbtLiteralValue.IntValue(value))
    }

    override infix fun NbtPredicateKey.eq(value: NbtLiteral) {
        scope.addEntry(name, value.value)
    }
