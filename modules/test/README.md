...
|----------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Content** ([`ContentMatchers`](src/main/kotlin/io/github/lmliam/kotventure/test/text/ContentMatchers.kt))                | `containText`, `haveContent` (flatten `TextComponent` leaves only — not `toPlainText()`)                                              | `shouldContainText`, `shouldNotContainText`, `shouldHaveContent`, `shouldNotHaveContent`                                                                                                                                                    |
